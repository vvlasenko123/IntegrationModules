...
import { Rect, Circle, Line, Star, Arrow, Transformer, Ellipse } from "react-konva";
            ...
            {isSelected && (
                <Transformer
                    ...
                    boundBoxFunc={(oldBox, newBox) => {
                        ...
                        if (newBox.height < 20 && !(shapeId === "stick" || shapeId === "arrow" || shapeId === "dblarrow" || shapeId === "line")) return oldBox;
                        return newBox;
                    }}
                />
            )}
